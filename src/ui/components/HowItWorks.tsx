    ...
    <section className="how-it-works-section" id="how-it-works">
      <div className="section-container">
        ...
        <div className="steps-slider-wrapper">
          ...
          >
            {/* Step 1 */}
            <div className={`step-card ${activeStep === 0 ? "active-mobile" : ""}`}>
            ...
            {/* Step 2 */}
            <div className={`step-card ${activeStep === 1 ? "active-mobile" : ""}`}>
              <div className="step-badge-wrapper">
            ...
            {/* Step 3 */}
            <div className={`step-card ${activeStep === 2 ? "active-mobile" : ""}`}>
              <div className="step-badge-wrapper">
        ...
        <div className="mobile-dots-indicator">
          <button 
            className={`dot ${activeStep === 0 ? "active" : ""}`} 
            onClick={() => scrollToStep(0)}
            aria-label="Go to step 1"
          />
          <button 
            className={`dot ${activeStep === 1 ? "active" : ""}`} 
            onClick={() => scrollToStep(1)}
            aria-label="Go to step 2"
          />
          <button 
            className={`dot ${activeStep === 2 ? "active" : ""}`} 
